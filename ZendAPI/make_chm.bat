...
rem !! about how to build a "extending_zend_lang.chm" file.

rem Path of the PHP CGI executable
set PHP_PATH=C:\Programme\php\php.exe

rem Path of the Help Compiler command line tool
set PHP_HELP_COMPILER=C:\devel\cvs\documentation\bin\hhc.exe
...
echo Compiling the actual helpfile (extending_zend_%PHP_HELP_COMPILE_LANG%.chm)...
%PHP_HELP_COMPILER% extending_zend_%PHP_HELP_COMPILE_LANG%.hhp

echo.
echo Cleaning up the directory
del extending_zend_%PHP_HELP_COMPILE_LANG%.hh?
