...
function MakeContentFiles()
{
    ...
    $toc = fopen("extending_zend_$language.hhc", "w");
    $index = fopen("extending_zend_$language.hhk", "w");
...
function MakeProjectFile()
{
    ...
    $project = fopen("extending_zend_$language.hhp", "w");
    fputs($project, "[OPTIONS]\n");
    fputs($project, "Compatibility=1.1 or later\n");
    fputs($project, "Compiled file=extending_zend_$language.chm\n");
    fputs($project, "Contents file=extending_zend_$language.hhc\n");
    fputs($project, "Index file=extending_zend_$language.hhk\n");
    ...
    fputs($project, "\n[WINDOWS]\nphpdoc=\"$manual_title\",\"extending_zend_$language.hhc\",\"extending_zend_$language.hhk\"," .
